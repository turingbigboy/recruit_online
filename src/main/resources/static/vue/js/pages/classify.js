	...
	methods:{
	  ...
	  //添加或者删除 由ID决定
		...
		findSubLabel:function(id){
			this.classId = id;
			var self = this;
			axios.get("/repast/product-sort/classify/"+id).then(function(res){
				console.log(res);
		...
		findSortById:function(id){
			var self = this;
			axios.get("/repast/product-sort/"+id).then(function(res){				
		...
		addSort:function(){
			...
			//修改
			axios.put("/repast/product-sort",this.sort).then(function(res){
				alert(res.data.msg);
				self.sort={};
		...
		saveSort:function(){
			...
			var self=this;
			axios.post("/repast/product-sort/",this.sort).then(function(res){
				alert(res.data.msg);
				self.sort={};
				self.findSubLabel(self.classId);
			}).catch(function(err){
		...
		removeSortById:function(id){
			var self=this;
			axios.delete("/repast/product-sort/"+id).then(function(res){
				alert(res.data.msg);			
				self.findSubLabel(self.classId);
			}).catch(function(err){
				alert(err);
