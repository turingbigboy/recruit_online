...
public class PositionController {
	...
	public AjaxResult<PositionVO> listBasePage(PositionVO vo){
		return AjaxResult.success("",positionService.listPage(new QueryWrapper<Position>(vo.convert())).converterAll(this::convert));
	}
	...
	private BasePage<PositionVO> convert(BasePage<Position> basePage) {
		...
		BasePage<PositionVO> result = new BasePage<PositionVO>(basePage.getPage(),
